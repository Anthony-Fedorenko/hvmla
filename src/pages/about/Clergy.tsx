...
const STAFF: StaffMember[] = [
  ...
  },
  {
    ...
    roleKey: "about.protodeaconAssistant",
    phone: "(323) 539-6139",
  ...
  {
    nameEn: "Deacon Serge Liberovsky",
    nameRu: "Диакон Серж Либеровский",
    roleKey: "about.choirDirector",
    phone: "516-362-7797",
    photo: "/serge-web.jpg",
    bioEn: "",
    bioRu: "",
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p
                    style={{
                      ...
                      marginBottom: member.phone ? "0.4rem" : "var(--space-sm)",
                      maxWidth: "none",
                    }}
                  >
                    {t(member.roleKey)}
                  ...
                  {member.phone && (
                    <p style={{ fontSize: "0.85rem", color: "var(--color-text-secondary)", marginBottom: "var(--space-sm)", maxWidth: "none" }}>
                      {member.phone}
                    </p>
                  )}
